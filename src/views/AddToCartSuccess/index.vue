        ...
        <div class="goods">
          <div class="left-good">
            ...
            <div class="right-info">
              <p class="title">{{ newCartItem.name }}</p>
              <p class="attr">
                数量:{{ newCartItem.num }}
              </p>
            </div>
          ...
          <div class="right-gocart">
            <router-link class="sui-btn btn-xlarge" :to="{path:'/detail',query:{skuId:newCartItem.skuId}}">查看商品详情</router-link>
